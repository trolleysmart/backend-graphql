            ...
            switch ((_context.prev = _context.next)) {
              case 0:
                return _context.abrupt(
                  'return',
                  new _trolleySmartParseServerCommon.StapleItemService().count(getCriteria(searchArgs, userId), sessionToken),
                );
            ...
            switch ((_context2.prev = _context2.next)) {
              case 0:
                return _context2.abrupt(
                  'return',
                  new _trolleySmartParseServerCommon.StapleItemService().search(
...
var getStapleItems = (exports.getStapleItems = (function() {
  var _ref3 = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee3(searchArgs, userId, sessionToken) {
      var finalSearchArgs,
        count,
          ...
          while (1) {
            switch ((_context3.prev = _context3.next)) {
              ...
              case 18:
                ...
                (_getLimitAndSkipValue = (0, _Common.getLimitAndSkipValue)(finalSearchArgs, count, 10, 1000)),
