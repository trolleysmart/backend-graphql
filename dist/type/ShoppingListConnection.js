...
var getShoppingListCountMatchCriteria = (function() {
  var _ref = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee(searchArgs, userId, sessionToken) {
            ...
            switch ((_context.prev = _context.next)) {
              case 0:
                return _context.abrupt(
                  'return',
                  new _trolleySmartParseServerCommon.ShoppingListService().count(getCriteria(searchArgs, userId), sessionToken),
                );
...
var getShoppingListMatchCriteria = (function() {
  var _ref2 = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee2(searchArgs, userId, sessionToken, limit, skip) {
      return regeneratorRuntime.wrap(
            ...
            switch ((_context2.prev = _context2.next)) {
              case 0:
                return _context2.abrupt(
                  'return',
                  new _trolleySmartParseServerCommon.ShoppingListService().search(
...
var getShoppingLists = (exports.getShoppingLists = (function() {
  var _ref3 = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee3(searchArgs, dataLoaders, sessionToken) {
      var userDefaultShoppingListLoader,
        ...
        function _callee3$(_context3) {
          while (1) {
            switch ((_context3.prev = _context3.next)) {
              case 0:
                (userDefaultShoppingListLoader = dataLoaders.userDefaultShoppingListLoader),
                  (userLoaderBySessionToken = dataLoaders.userLoaderBySessionToken);
                _context3.next = 3;
