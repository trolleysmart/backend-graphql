...
var ParentTagType = new _graphql.GraphQLObjectType({
  name: 'ParentTag',
  fields: {
    id: {
...
var TagConnectionDefinition = (0, _graphqlRelay.connectionDefinitions)({
  name: 'TagType',
  nodeType: TagType
});
...
exports.default = { TagType: TagType, TagConnectionDefinition: TagConnectionDefinition };