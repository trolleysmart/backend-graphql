...
var getShoppingList = (exports.getShoppingList = (function() {
  var _ref = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee(shoppingListId, sessionToken) {
...
var getUserDefaultShoppingList = (exports.getUserDefaultShoppingList = (function() {
  var _ref2 = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee2(dataLoaders, sessionToken) {
      return regeneratorRuntime.wrap(
          ...
          while (1) {
            switch ((_context2.prev = _context2.next)) {
              case 0:
                ...
                _context2.next = 3;
                return dataLoaders.userDefaultShoppingListLoader.load(sessionToken);
    ...
    totalItemsCount: {
      ...
      resolve: (function() {
        var _ref3 = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee3(_, args, _ref4) {
              ...
              function _callee3$(_context3) {
                while (1) {
                  switch ((_context3.prev = _context3.next)) {
                    case 0:
                      _context3.next = 2;
                      return (0, _ShoppingListItemConnection.getShoppingListItems)(
                        (0, _immutable.Map)({ first: 1000 }),
                        _.get('id'),
                        dataLoaders,
                        sessionToken,
                      );
    ...
    shoppingListItems: {
      ...
      resolve: (function() {
        var _ref5 = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee4(_, args, _ref6) {
