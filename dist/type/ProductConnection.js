          ...
          case 2:
            ...
            return _context.abrupt('return', (0, _immutable.Map)({
              ...
              conditions: (0, _immutable.Map)({
                ...
                status: 'A'
              }).merge(productSearchConfig.get('returnCrawledProducts') ? (0, _immutable.Map)() : (0, _immutable.Map)({ createdByCrawler: true })).merge(productSearchConfig.get('returnProductsOnSpecialOnly') ? (0, _immutable.Map)() : (0, _immutable.Map)({ notEqual_special: 'none' })).merge(!productSearchConfig.get('returnProductsOnSpecialOnly') && searchArgs.has('special') ? (0, _immutable.Map)() : (0, _immutable.Map)({ special: searchArgs.get('special') })).merge(searchArgs.has('tagIds') ? (0, _immutable.Map)() : (0, _immutable.Map)({ tagIds: searchArgs.get('tagIds') })).merge(searchArgs.has('storeIds') ? (0, _immutable.Map)() : (0, _immutable.Map)({ storeIds: searchArgs.get('storeIds') }))
            }));
