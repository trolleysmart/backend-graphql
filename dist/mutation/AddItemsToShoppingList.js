...
exports.default = (0, _graphqlRelay.mutationWithClientMutationId)({
  ...
  mutateAndGetPayload: (function() {
    var _ref = _asyncToGenerator(
      /*#__PURE__*/ regeneratorRuntime.mark(function _callee(_ref2, request) {
            ...
            while (1) {
              switch ((_context.prev = _context.next)) {
                ...
                case 6:
                  ...
                  _context.next = 12;
                  return Promise.all([
                    (0, _ProductPriceHelper2.default)(finalProductPriceIds, user, shoppingListId, sessionToken),
                    (0, _StapleItemHelper.addStapleItemsToShoppingList)(finalStapleItemIds, user, shoppingListId, sessionToken),
                    (0, _StapleItemHelper.addNewStapleItemsToShoppingList)(
                      newStapleItemNames ? _immutable2.default.fromJS(newStapleItemNames) : (0, _immutable.List)(),
                      user,
                      shoppingListId,
                      sessionToken,
                    ),
                ...
                case 16:
                  ...
                  shoppingListItemsToReturn = shoppingListItems
                    .filter(function(shoppingListItem) {
                      return newShoppingListItemIds.find(function(id) {
                        return id.localeCompare(shoppingListItem.node.get('id')) === 0;
                      });
                    })
                    .concat(
                      shoppingListItems.filter(function(shoppingListItem) {
                ...
                case 21:
                  ...
                  return _context.abrupt(
                    'return',
                    (0, _immutable.Map)({ errorMessage: _context.t2 instanceof Error ? _context.t2.message : _context.t2 }),
                  );
