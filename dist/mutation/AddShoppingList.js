            ...
            while (1) {
              switch ((_context.prev = _context.next)) {
                ...
                case 7:
                  ...
                  _context.next = 11;
                  return (0, _type.getShoppingLists)(
                    (0, _immutable.Map)({ shoppingListIds: _immutable.List.of(shoppingListId) }),
                    user.id,
                    sessionToken,
                  );
                ...
                case 16:
                  ...
                  return _context.abrupt(
                    'return',
                    (0, _immutable.Map)({ errorMessage: _context.t3 instanceof Error ? _context.t3.message : _context.t3 }),
                  );
