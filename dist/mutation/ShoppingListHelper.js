...
var getShoppingListItemById = (function() {
  var _ref = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee(id, sessionToken) {
...
var getAllShoppingListItemsContainProvidedProductPrice = (function() {
  var _ref2 = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee2(productPriceId, shoppingListId, sessionToken) {
      return regeneratorRuntime.wrap(
            ...
            switch ((_context2.prev = _context2.next)) {
              case 0:
                return _context2.abrupt(
                  'return',
                  new _trolleySmartParseServerCommon.ShoppingListItemService().search(
                    (0, _immutable.Map)({
...
var getAllShoppingListItemsContainProvidedStapleItem = (function() {
  var _ref3 = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee3(stapleItemId, shoppingListId, sessionToken) {
      return regeneratorRuntime.wrap(
...
var getShoppingListById = (exports.getShoppingListById = (function() {
  var _ref4 = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee4(id, sessionToken) {
      return regeneratorRuntime.wrap(
...
var removeItemsFromShoppingList = (exports.removeItemsFromShoppingList = (function() {
  var _ref5 = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee5(shoppingListItemIds, dataLoaders, shoppingListId, sessionToken) {
      var shoppingListItemsPromises,
        allShoppingListItems,
        shoppingListItems,
        productPriceIds,
        stapleItemIds,
        shoppingListItemService,
        itemsToRemovePromises,
        itemsToRemove,
        userId,
        _itemsToRemovePromises,
        _itemsToRemove,
        _userId;
        ...
        function _callee5$(_context5) {
          while (1) {
            switch ((_context5.prev = _context5.next)) {
              ...
              case 2:
                shoppingListItemsPromises = shoppingListItemIds
                  .map(function(id) {
              ...
              case 6:
                ...
                productPriceIds = shoppingListItems
                  .filter(function(_) {
                  ...
                  .valueSeq()
                  .toList();
                stapleItemIds = shoppingListItems
                  .filter(function(_) {
                ...
                itemsToRemovePromises = productPriceIds
                  .map(function(productPriceId) {
              ...
              case 25:
                ...
                _itemsToRemovePromises = stapleItemIds
                  .map(function(stapleItemId) {
...
var addShoppingListForProvidedUser = (exports.addShoppingListForProvidedUser = (function() {
  var _ref6 = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee6(name, user, sessionToken) {
      var acl;
      return regeneratorRuntime.wrap(
            ...
            switch ((_context6.prev = _context6.next)) {
              case 0:
                ...
                return _context6.abrupt(
                  'return',
                  new _trolleySmartParseServerCommon.ShoppingListService().create(
                    (0, _immutable.Map)({ name: name, user: user, status: 'A' }),
                    acl,
                    sessionToken,
                  ),
                );
...
var addShoppingList = (exports.addShoppingList = (function() {
  var _ref7 = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee7(name, dataLoaders, sessionToken) {
      var user;
      return regeneratorRuntime.wrap(
...
var updateShoppingList = (exports.updateShoppingList = (function() {
  var _ref8 = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee8(shoppingListId, name, sessionToken) {
...
var removeShoppingList = (exports.removeShoppingList = (function() {
  var _ref9 = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee9(shoppingListId, sessionToken) {
      var shoppingListService, shoppingList;
      return regeneratorRuntime.wrap(
...
var setUserDefaultShoppingListForProvidedUser = (exports.setUserDefaultShoppingListForProvidedUser = (function() {
  var _ref10 = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee10(shoppingListId, user, sessionToken) {
            ...
            switch ((_context10.prev = _context10.next)) {
              ...
              case 3:
                ...
                return _context10.abrupt(
                  'return',
                  defaultShoppingListService.create(
                    (0, _immutable.Map)({ user: user, shoppingListId: shoppingListId }),
                    _microBusinessParseServerCommon.ParseWrapperService.createACL(user),
                    sessionToken,
                  ),
                );
              ...
              case 8:
                ...
                return _context10.abrupt(
                  'return',
                  defaultShoppingListService.update(defaultShoppingLists.first().set('shoppingListId', shoppingListId), sessionToken),
                );
...
var setUserDefaultShoppingList = (exports.setUserDefaultShoppingList = (function() {
  var _ref11 = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee11(shoppingListId, dataLoaders, sessionToken) {
      var user;
      return regeneratorRuntime.wrap(
